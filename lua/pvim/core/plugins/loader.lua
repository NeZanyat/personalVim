...
function plugin_loader.init(opts)
  ...
  if pvim.log and pvim.log.level then
    log_level = pvim.log.level
  end
  ...
  if not in_headless then
    vim.cmd [[autocmd User PackerComplete lua require('pvim.core.misc.hooks').run_on_packer_complete()]]
  end
end
...
function plugin_loader.get_core_plugins()
  local list = {}
  local plugins = require "pvim.core.plugins.builtin"
